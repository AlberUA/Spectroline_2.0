...
function initSliders() {
  if (document.querySelector(".what-create__slider")) {
    new Swiper(".what-create__slider", {
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".slider-what-create-controls__button--prev",
        nextEl: ".slider-what-create-controls__button--next"
      },
      // Брейкпоінти
      breakpoints: {
        320: {
  ...
  if (document.querySelector(".projects__slider")) {
    new Swiper(".projects__slider", {
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".controls-projects-slider__button--prev",
        nextEl: ".controls-projects-slider__button--next"
      },
      // Брейкпоінти
      breakpoints: {
        320: {
  ...
  if (document.querySelector(".projects-popup-services__slider")) {
    new Swiper(".projects-popup-services__slider", {
      // <- Вказуємо склас потрібного слайдера
      // Підключаємо модулі слайдера
      // для конкретного випадку
      modules: [Navigation],
...
window.addEventListener("load", () => {
  ...
  const logo = document.querySelector(".preloader__logo-wrapper");
